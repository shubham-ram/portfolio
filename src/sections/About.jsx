...
export default function About() {
  ...
  return (
    <section id="about" className="section-padding px-4 md:px-8 max-w-6xl mx-auto">
      {/* Section heading */}
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-medium text-amber-400/80 uppercase tracking-wider">Journey</span>
            </div>
            <p className="text-white/80 text-lg leading-relaxed font-light">
              With over <span className="text-white font-medium">3 years</span> of experience in frontend engineering,
              I specialize in crafting pixel-perfect, performant web experiences. I love bridging the gap between
              design and engineering — turning complex interactions into smooth, intuitive interfaces.
            </p>
            <p className="text-white/60 text-base leading-relaxed font-light mt-4">
              Currently exploring WebXR, spatial UIs, and AI-powered developer tools.
              When I'm not coding, you'll find me exploring new design trends or tinkering with creative experiments.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="text-5xl md:text-6xl font-heading font-extrabold text-gradient mb-2">3+</div>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-amber-400/80 uppercase tracking-wider">Tech Stack</span>
            </div>
        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-white/40 text-sm mt-1">Available for remote work</p>
          </div>
        </motion.div>
      </motion.div>
    </section>
